...
public class KarmaBoosting
{
    ...
    private static void KarmaMeter_Update(On.HUD.KarmaMeter.orig_Update orig, KarmaMeter self)
    {
        ...
        if (self.hud.owner != null && self.hud.owner is Player && (self.hud.owner as Player).room != null && (self.hud.owner as Player).SlugCatClass == PBEnums.SlugcatStatsName.Beacon
            && (self.hud.owner as Player).room.world.region != null)
        {

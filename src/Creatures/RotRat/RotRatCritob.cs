...
{
    public RotRatCritob() : base(Enums.CreatureTemplateType.Rotrat)
    {
        Icon = new SimpleIcon("Kill_Mouse", Colors.NightmareColor);
        LoadedPerformanceCost = 100f;
        SandboxPerformanceCost = new SandboxPerformanceCost(0.5f, 0.5f);
        RegisterUnlock(KillScore.Configurable(3), Enums.SandboxUnlockID.RotRat);
    }
    ...
    {
        CreatureTemplate t = new CreatureFormula(CreatureTemplate.Type.LanternMouse, Enums.CreatureTemplateType.Rotrat, "Rotrat").IntoTemplate();
    ...
    {
        Relationships rels = new Relationships(Enums.CreatureTemplateType.Rotrat);

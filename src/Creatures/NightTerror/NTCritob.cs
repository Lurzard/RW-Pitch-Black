...
sealed class NTCritob : Critob
{
    internal NTCritob() : base(Enums.CreatureTemplateType.NightTerror)
    {
        Icon = new SimpleIcon("Night_Terror", Colors.NightmareColor);
        RegisterUnlock(KillScore.Configurable(25), Enums.SandboxUnlockID.NightTerror);
